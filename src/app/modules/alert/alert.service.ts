...
const infoSvg = '<?xml version="1.0" encoding="iso-8859-1"?>\n' +
    '\n' +
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" ' +
    'x="0px" y="0px" width="512px" height="512px" viewBox="0 0 442.761 442.762" style="enable-background:new 0 0 ' +
...
export class AlertService {
    ...
    private getElement(message: any, type: string) {
        ...
        const messageBlock = this.renderer.createElement('span');
    ...
    private setRemovable(parent, el) {
        const anc = this.renderer.createElement('a');
